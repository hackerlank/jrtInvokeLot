...
public class JSONReslutUtil {
	...
	public static JSONObject getUserNo(HttpServletRequest request){
		...
		if(jsessionid != null){
			String obj;
			try {
				obj = getResultMessage(usersCenterUrl+"user/center!getUserNo;jsessionid="+jsessionid+"?","a="+Math.random(),"POST");
	...
	public static JSONObject getUserInfo(HttpServletRequest request){
		...
		if(jsessionid != null){
			try {
				...
				if(StringUtils.isBlank(obj)){
					obj = getResultMessage(usersCenterUrl+"user/center!getUserInfo;jsessionid="+jsessionid+"?","a="+Math.random(),"POST");
					if(StringUtils.isBlank(obj)){
						return null;
					}
					return JSONObject.fromObject(obj);
